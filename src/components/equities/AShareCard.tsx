      ...
      <CardContent>
        <dl className="grid grid-cols-2 gap-1.5 text-xs">
          <div className="rounded bg-muted/50 px-1.5 py-1">
            <dt className="text-xs uppercase text-muted-foreground">{t("metric.change1w")}</dt>
          ...
          <div className="rounded bg-muted/50 px-1.5 py-1">
            <dt className="text-xs uppercase text-muted-foreground">{t("metric.change1m")}</dt>
          ...
          <div className="rounded bg-muted/50 px-1.5 py-1">
            <dt className="text-xs text-muted-foreground">{t("metric.rsi14")}</dt>
            <dd className="font-medium tabular-nums">
              {asset.rsi14 === null ? t("common:data.na") : formatNumber(asset.rsi14, locale, 1)}
            </dd>
          </div>
          <div className="rounded bg-muted/50 px-1.5 py-1">
            <dt className="text-xs uppercase text-muted-foreground">{t("metric.percentile1y")}</dt>
            <dd className="font-medium tabular-nums">
